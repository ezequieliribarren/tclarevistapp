...
const { obtenerYMostrarDatos, horarios } = require('./tcp/horarios.js');
...
// VIVO
const {en1V} = require ('./tcp/tcp/entrenamiento1.js')
const {en2V} = require ('./tcp/tcp/entrenamiento2.js')
const {en3V} = require ('./tcp/tcp/entrenamiento3.js')
const {en4V} = require ('./tcp/tcp/entrenamiento4.js')
const {en5V} = require ('./tcp/tcp/entrenamiento5.js')
const {en6V} = require ('./tcp/tcp/entrenamiento6.js')
const {clasificacionV} = require ('./tcp/tcp/clasificacion.js')
const {serie1V} = require ('./tcp/tcp/serie1.js')
const {serie2V} = require ('./tcp/tcp/serie2.js')
const {finalV} = require ('./tcp/tcp/final.js')
const { horariosV } = require('./tcp/tcp/horarios.js');
const { pilotosV } = require('./tcp/tcp/pilotos.js');
const {  menuV } = require('./tcp/tcp/menu.js');


const jsonFilePath1 = path.join(__dirname, 'tcp', 'en1.json');
const jsonFilePath2 = path.join(__dirname, 'tcp', 'en2.json');
const jsonFilePath3 = path.join(__dirname, 'tcp', 'en3.json');
const jsonFilePath4 = path.join(__dirname, 'tcp', 'en4.json');
const jsonFilePath5 = path.join(__dirname, 'tcp', 'en5.json');
const jsonFilePath6 = path.join(__dirname, 'tcp', 'en6.json');
const jsonFilePathClasificacion = path.join(__dirname, 'tcp', 'clasificacion.json');
const jsonFilePathSerie1= path.join(__dirname, 'tcp', 'serie1.json');
const jsonFilePathSerie2= path.join(__dirname, 'tcp', 'serie2.json');
const jsonFilePathFinal= path.join(__dirname, 'tcp', 'final.json');
const jsonFilePathPilotos= path.join(__dirname, 'tcp', 'pilotos.json');
