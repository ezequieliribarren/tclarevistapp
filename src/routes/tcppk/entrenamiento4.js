...
const { obtenerDatosDesdeGoogleSheets } = require('../googleSheets.js'); // Corregir el nombre de la función importada

async function en4() {
  try {
    // Obtener los datos desde Google Sheets
    const sheetId = "1112076324"; // ID de la hoja que deseas obtener
    const datos = await obtenerDatosDesdeGoogleSheets([sheetId]); // Corregir el nombre de la función llamada
