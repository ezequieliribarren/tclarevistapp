...
// 1° ENTRENAMIENTO
router.get('/restcpm/en1', async (req, res) => {
    try {
...
// 2° ENTRENAMIENTO
router.get('/restcpm/en2', async (req, res) => {
    try {
      // Obtén los datos completos
...
// 3° ENTRENAMIENTO
router.get('/restcpm/en3', async (req, res) => {
    try {
      // Obtén los datos completos
...
// 4° ENTRENAMIENTO
router.get('/restcpm/en4', async (req, res) => {
    try {
      // Obtén los datos completos
...
// 5° ENTRENAMIENTO
router.get('/restcpm/en5', async (req, res) => {
    try {
      // Obtén los datos completos
...
// 6° ENTRENAMIENTO
router.get('/restcpm/en6', async (req, res) => {
    try {
      // Obtén los datos completos
...
// CLASIFICACION
router.get('/restcpm/clasificacion', async (req, res) => {
  try {
    // Obtén los datos completos
...
// 1° SERIE
router.get('/restcpm/serie1', async (req, res) => {
      try {
        // Obtén los datos completos
...
// 2° SERIE
router.get('/restcpm/serie2', async (req, res) => {
  try {
    // Obtén los datos completos
...
// 6° FINAL
router.get('/restcpm/final', async (req, res) => {
      try {
        // Obtén los datos completos
