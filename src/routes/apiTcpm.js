...
// VIVO
const {en1V} = require ('./tcpm/tcpm/entrenamiento1.js')
const {en2V} = require ('./tcpm/tcpm/entrenamiento2.js')
const {en3V} = require ('./tcpm/tcpm/entrenamiento3.js')
const {en4V} = require ('./tcpm/tcpm/entrenamiento4.js')
const {en5V} = require ('./tcpm/tcpm/entrenamiento5.js')
const {en6V} = require ('./tcpm/tcpm/entrenamiento6.js')
const {clasificacionV} = require ('./tcpm/tcpm/clasificacion.js')
const {serie1V} = require ('./tcpm/tcpm/serie1.js')
const {serie2V} = require ('./tcpm/tcpm/serie2.js')
const {finalV} = require ('./tcpm/tcpm/final.js')
const { horariosV } = require('./tcpm/tcpm/horarios.js');
const { pilotosV } = require('./tcpm/tcpm/pilotos.js');
const { menuV } = require('./tcpm/tcpm/menu.js');
