...
async function scrapeData4menu() {
    ...
    try {
        ...
        if (url) {
            ...
            const secondMenuItem = await page.$('.menuTabFijo li:nth-child(4) a');
            ...
            for (const h3 of h3Elements) {
                ...
                const liDatas = await page.evaluateHandle(h3 => {
                    ...
                    while (siblingElement && siblingElement.tagName === 'LI' && siblingElement.classList.contains('datas')) {
                        ...
                        datas.push({ tanda: siblingElement.textContent.trim(), estado, ip: "ip4" });
...
module.exports = scrapeData4menu;
