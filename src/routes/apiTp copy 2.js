...
// VIVO
const { en1V } = require('./tp-c2/tp-c2/entrenamiento1.js')
const { en2V } = require('./tp-c2/tp-c2/entrenamiento2.js')
const { en3V } = require('./tp-c2/tp-c2/entrenamiento3.js')
const { en4V } = require('./tp-c2/tp-c2/entrenamiento4.js')
const { en5V } = require('./tp-c2/tp-c2/entrenamiento5.js')
const { en6V } = require('./tp-c2/tp-c2/entrenamiento6.js')
const { clasificacionV } = require('./tp-c2/tp-c2/clasificacion.js')
const { serie1V } = require('./tp-c2/tp-c2/serie1.js')
const { serie2V } = require('./tp-c2/tp-c2/serie2.js')
const { finalV} = require('./tp-c2/tp-c2/final.js');
const { menuV } = require('./tp-c2/tp-c2/menu.js');
const { serie3V } = require('./tp-c2/tp-c2/serie3.js');
