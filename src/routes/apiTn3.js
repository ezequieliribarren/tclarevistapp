...
// const { obtenerYMostrarDatos, horarios } = require('./tn3/horarios.js');
const { pilotos } = require('./tn3/pilotos.js');
const { sheets, menu } = require('./tn3/menu.js');
...
const jsonFilePath5 = path.join(__dirname, 'tn3', 'en5.json');
const jsonFilePath6 = path.join(__dirname, 'tn3', 'en6.json');
const jsonFilePathClasificacion = path.join(__dirname, 'tn3', 'clasificacion.json');
const jsonFilePathSerie1= path.join(__dirname, 'tn3', 'serie1.json');
const jsonFilePathSerie2= path.join(__dirname, 'tn3', 'serie2.json');
const jsonFilePathSerie3= path.join(__dirname, 'tn3', 'serie3.json');
const jsonFilePathFinal= path.join(__dirname, 'tn3', 'final.json');
const jsonFilePathPilotos= path.join(__dirname, 'tn3', 'pilotos.json');
