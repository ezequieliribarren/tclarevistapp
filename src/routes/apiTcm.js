...
// VIVO
const {en1V} = require ('./tcm/tcm/entrenamiento1.js')
const {en2V} = require ('./tcm/tcm/entrenamiento2.js')
const {en3V} = require ('./tcm/tcm/entrenamiento3.js')
const {en4V} = require ('./tcm/tcm/entrenamiento4.js')
const {en5V} = require ('./tcm/tcm/entrenamiento5.js')
const {en6V} = require ('./tcm/tcm/entrenamiento6.js')
const {clasificacionV} = require ('./tcm/tcm/clasificacion.js')
const {serie1V} = require ('./tcm/tcm/serie1.js')
const {serie2V} = require ('./tcm/tcm/serie2.js')
const {finalV} = require ('./tcm/tcm/final.js')
const { horariosV } = require('./tcm/tcm/horarios.js');
const { pilotosV } = require('./tcm/tcm/pilotos.js');
const { menuV } = require('./tcm/tcm/menu.js');
